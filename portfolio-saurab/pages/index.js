...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        <title>Saurab Poudel Portfolio</title>
      ...
      <main className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900'>
        <section className=' min-h-screen'>
          <nav className='py-10 mb-12 flex justify-between'>
            <h1 className='text-xl font-burtons dark:text-white '>saurabpoudel</h1>
          ...
          <div className='text-center p-10'>
            <h2 className='text-5xl py-2 text-teal-600 dark:text-teal-400 font-medium md:text-6xl'>Saurab Poudel</h2>
            ...
            <p className='text-md py-5 leading-8 text-gray-800 dark:text-gray-200 md:text-xl max-w-lg mx-auto'>
              Freelancer providing services to programming and design content needs. Join me down below and let's get cracking.
            </p>
          </div>
        ...
        <section>
          <div>
            ...
            <p className='text-md py-2 leading-8 text-gray-800 dark:text-gray-200'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias error
                 illum architecto est quaerat cumque aperiam illo, fugiat quo voluptas fuga. Dignissimos est sint totam, tempore repellendus ut ab expedita.
            </p>
          </div>
          <div className='lg:flex gap-10'>
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white">
              ...
              <p className='py-2'>
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aliquam temporibus vel eveniet animi nihil?
              </p>
            ...
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white">
              ...
              <h3 className='text-lg font-medium pt-8 pb-2'>Code your Beutiful projects</h3>
              <p className='py-2'>
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aliquam temporibus vel eveniet animi nihil?
              </p>
              <h4 className='py-4 text-teal-600'>Design tools I use</h4>
